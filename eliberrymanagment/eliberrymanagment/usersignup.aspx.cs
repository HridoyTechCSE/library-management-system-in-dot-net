    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (checkMemberExist())
            {
                ...
                Response.Write("<script>alert('memeber allready exist try other id '); </script>");
            }
            else {
                signUpNewMember();
            }
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl(full_name,dob,contact_no,email,state,city,pincode,full_address,member_id,password,account_status) values(@full_name,@dob,@contact_no," +
